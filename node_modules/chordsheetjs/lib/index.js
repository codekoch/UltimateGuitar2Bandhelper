...
"use strict";
function $ea7c5d4e4ce912f8$var$peg$padEnd(str, targetLength, padString) {
    padString = padString || " ";
...
class $ea7c5d4e4ce912f8$export$628c65c376ead699 extends Error {
    ...
    constructor(message, expected, found, location){
        ...
        if (typeof Object.setPrototypeOf === "function") Object.setPrototypeOf(this, $ea7c5d4e4ce912f8$export$628c65c376ead699.prototype);
        else this.__proto__ = $ea7c5d4e4ce912f8$export$628c65c376ead699.prototype;
        if (typeof Error.captureStackTrace === "function") Error.captureStackTrace(this, $ea7c5d4e4ce912f8$export$628c65c376ead699);
    }
    format(sources) {
        ...
        if (this.location) {
            ...
            if (src) {
                ...
                let filler = $ea7c5d4e4ce912f8$var$peg$padEnd("", s.line.toString().length, " ");
                let line = src[s.line - 1];
                let last = s.line === e.line ? e.column : line.length + 1;
                str += "\n --> " + loc + "\n" + filler + " |\n" + s.line + " | " + line + "\n" + filler + " | " + $ea7c5d4e4ce912f8$var$peg$padEnd("", s.column - 1, " ") + $ea7c5d4e4ce912f8$var$peg$padEnd("", last - s.column, "^");
            } else str += "\n at " + loc;
        }
        return str;
    }
}
function $ea7c5d4e4ce912f8$var$peg$parse(input, options) {
    ...
    function peg$buildSimpleError(message, location1) {
        return new $ea7c5d4e4ce912f8$export$628c65c376ead699(message, [], "", location1);
    }
    function peg$buildStructuredError(expected1, found, location1) {
        return new $ea7c5d4e4ce912f8$export$628c65c376ead699($ea7c5d4e4ce912f8$export$628c65c376ead699.buildMessage(expected1, found), expected1, found, location1);
    }
...
const $ea7c5d4e4ce912f8$export$98e6a39c04603d36 = $ea7c5d4e4ce912f8$var$peg$parse;
...
class $8fcf445ea0999053$var$Note {
    ...
    static parse(note) {
        ...
        if (/^[A-Ga-g]$/.test(noteString)) return new $8fcf445ea0999053$var$Note({
            note: noteString.toUpperCase(),
            type: (0, $af8d31735c159a26$export$27c95a7104c1f7aa)
        });
        if (/^[1-7]$/.test(noteString)) return new $8fcf445ea0999053$var$Note({
            note: parseInt(noteString, 10),
            type: (0, $af8d31735c159a26$export$4d318981b5a83836)
        });
        const romanNumeralValue = $8fcf445ea0999053$var$numeralToNumber(noteString);
    ...
    getTransposeDistance(minor) {
        if (typeof this._note === "number") {
            if (minor && this._note in $8fcf445ea0999053$var$TRANSPOSE_DISTANCE_MINOR) return $8fcf445ea0999053$var$TRANSPOSE_DISTANCE_MINOR[this._note];
            if (this._note in $8fcf445ea0999053$var$TRANSPOSE_DISTANCE_MAJOR) return $8fcf445ea0999053$var$TRANSPOSE_DISTANCE_MAJOR[this._note];
        }
        return 0;
    }
    change(delta) {
...
const $6ebb068142750218$var$enharmonics = {
    "Ab": {
        "B": "Cb"
    },
    "Cb": {
...
const $21a34a464e7bc609$export$d332d76d125f0cbe = (line)=>line.items.some((item)=>item instanceof (0, $d454f4215ba01af2$export$2e2bcd8739ae039) && !!item.chords);
const $21a34a464e7bc609$export$e3f63561d52b936d = (item)=>"evaluate" in item && typeof item.evaluate === "function";
const $21a34a464e7bc609$export$bc3bea8325045070 = (string, length)=>{
...
const $21a34a464e7bc609$export$844ec244b1367d54 = (obj)=>typeof obj === "string";
...
function $bff5407e03fdc8ee$var$modifierTransposition(modifier) {
    switch(modifier){
 ...
 */ class $bff5407e03fdc8ee$var$Key {
    ...
    static parse(keyString) {
        ...
        for(let i = 0, count = $bff5407e03fdc8ee$var$regexes.length; i < count; i += 1){
            const match = keyString.match($bff5407e03fdc8ee$var$regexes[i]);
            if (match) {
    ...
    static toString(keyStringOrObject) {
        return `${$bff5407e03fdc8ee$var$Key.wrapOrFail(keyStringOrObject)}`;
    }
    /**
   ...
   */ static distance(oneKey, otherKey) {
    ...
    distanceTo(otherKey) {
        const otherKeyObj = $bff5407e03fdc8ee$var$Key.wrapOrFail(otherKey);
    ...
    toChordSymbol(key) {
        ...
        const transposeDistance = this.note.getTransposeDistance(key.minor) + $bff5407e03fdc8ee$var$modifierTransposition(this.modifier);
    ...
    normalizeEnharmonics(key) {
        if (key) {
            const rootKeyString = $bff5407e03fdc8ee$var$Key.wrapOrFail(key).toString({
                showMinor: true
            });
            ...
            if (enharmonics && enharmonics[thisKeyString]) return $bff5407e03fdc8ee$var$Key.parseOrFail(enharmonics[thisKeyString]);
        }
        return this.clone();
    }
    set(attributes) {
 ...
 */ class $26f57998457eb2d4$var$Chord {
   ...
   */ toChordSymbol(referenceKey = null) {
        ...
        const keyObj = (0, $bff5407e03fdc8ee$export$2e2bcd8739ae039).wrapOrFail(referenceKey);
        let chordSymbolChord = new $26f57998457eb2d4$var$Chord({
            suffix: this.suffix ? $26f57998457eb2d4$var$normalizeChordSuffix(this.suffix) : null,
   ...
   */ transpose(delta) {
    ...
    determineRoot(root, base, modifier, suffix) {
        ...
        return new (0, $bff5407e03fdc8ee$export$2e2bcd8739ae039)({
            note: base,
            modifier: modifier,
            minor: (0, $21a34a464e7bc609$export$51fabfbeed747719)(suffix)
        });
    }
    determineBass(bass, bassBase, bassModifier) {
        if (bass) return bass;
        if (bassBase) return new (0, $bff5407e03fdc8ee$export$2e2bcd8739ae039)({
            note: bassBase,
 ...
 */ class $d454f4215ba01af2$var$ChordLyricsPair {
   ...
   */ clone() {
    ...
    set({ chords: chords , lyrics: lyrics  }) {
        return new $d454f4215ba01af2$var$ChordLyricsPair(chords || this.chords, lyrics || this.lyrics);
    }
    setLyrics(lyrics) {
        return this.set({
            lyrics: lyrics
...
const $5e9ede69210ec54a$export$2b0cbe6e95114098 = "chordfont";
const $5e9ede69210ec54a$export$1f62a95bf5703cac = "chordsize";
const $5e9ede69210ec54a$export$f7227d9f34d97bec = "chordcolour";
const $5e9ede69210ec54a$export$14fe4ba6e94df04d = "textfont";
const $5e9ede69210ec54a$export$f0dee7f48597f09a = "textsize";
const $5e9ede69210ec54a$export$d2ed2b49c006eb23 = "textcolour";
const $5e9ede69210ec54a$export$7e71e3df83ac1c9b = "titlefont";
const $5e9ede69210ec54a$export$6adbad8fc3f3d0e2 = "titlesize";
const $5e9ede69210ec54a$export$964db987ba9b8470 = "titlecolour";
const $5e9ede69210ec54a$export$8db6c706fc9142b2 = "chorus";
...
const $5e9ede69210ec54a$var$TEXTFONT_SHORT = "tf";
const $5e9ede69210ec54a$var$TEXTSIZE_SHORT = "ts";
...
const $5e9ede69210ec54a$var$SECTION_DELIMITERS = [
    ...
    $5e9ede69210ec54a$export$640d294ab83f9040
];
const $5e9ede69210ec54a$var$INLINE_FONT_TAGS = [
    $5e9ede69210ec54a$export$2b0cbe6e95114098,
    $5e9ede69210ec54a$export$1f62a95bf5703cac,
    $5e9ede69210ec54a$export$f7227d9f34d97bec,
    $5e9ede69210ec54a$export$14fe4ba6e94df04d,
    $5e9ede69210ec54a$export$f0dee7f48597f09a,
    $5e9ede69210ec54a$export$d2ed2b49c006eb23
];
...
const $5e9ede69210ec54a$var$ALIASES = {
    ...
    [$5e9ede69210ec54a$var$CHORDFONT_SHORT]: $5e9ede69210ec54a$export$2b0cbe6e95114098,
    [$5e9ede69210ec54a$var$CHORDSIZE_SHORT]: $5e9ede69210ec54a$export$1f62a95bf5703cac,
    [$5e9ede69210ec54a$var$TEXTFONT_SHORT]: $5e9ede69210ec54a$export$14fe4ba6e94df04d,
    [$5e9ede69210ec54a$var$TEXTSIZE_SHORT]: $5e9ede69210ec54a$export$f0dee7f48597f09a
};
 ...
 */ class $5e9ede69210ec54a$var$Tag extends (0, $cf00b4d3af89fa07$export$2e2bcd8739ae039) {
    ...
    isSectionDelimiter() {
        return $5e9ede69210ec54a$var$SECTION_DELIMITERS.includes(this.name);
    }
    isInlineFontTag() {
        return $5e9ede69210ec54a$var$INLINE_FONT_TAGS.includes(this.name);
    }
    set name(name) {
   ...
   * @returns {boolean}
   */ isRenderable() {
        return $5e9ede69210ec54a$var$RENDERABLE_TAGS.includes(this.name) || this.hasRenderableLabel();
    }
    /**
   ...
   */ hasRenderableLabel() {
        return $5e9ede69210ec54a$var$DIRECTIVES_WITH_RENDERABLE_LABEL.includes(this.name) && this.hasValue();
    }
    /**
...
var $7de89f83a0afd136$export$2e2bcd8739ae039 = $7de89f83a0afd136$var$Font;
 ...
 */ class $bc411321e9739719$var$Line {
   ...
   */ type = (0, $af8d31735c159a26$export$c53d0f541b41b88e);
    currentChordLyricsPair = new (0, $d454f4215ba01af2$export$2e2bcd8739ae039)();
    key = null;
    transposeKey = null;
    lineNumber = null;
    /**
   ...
   * @type {Font}
   */ textFont = new (0, $7de89f83a0afd136$export$2e2bcd8739ae039)();
    /**
   ...
   * @type {Font}
   */ chordFont = new (0, $7de89f83a0afd136$export$2e2bcd8739ae039)();
   ...
   */ hasContent() {
    ...
    addTag(nameOrTag, value = null) {
        const tag = nameOrTag instanceof (0, $5e9ede69210ec54a$export$2e2bcd8739ae039) ? nameOrTag : new (0, $5e9ede69210ec54a$export$2e2bcd8739ae039)(nameOrTag, value);
        this.items.push(tag);
        return tag;
    }
    addComment(content) {
...
function $1406c61233580008$var$appendValue(array, value) {
 ...
 */ class $1406c61233580008$var$Metadata extends (0, $59abde4480df2d69$export$2e2bcd8739ae039) {
    ...
    add(key, value) {
        ...
        if (currentValue instanceof Array) {
            $1406c61233580008$var$appendValue(currentValue, value);
            return;
        }
        this.metadata[key] = [
            currentValue,
   ...
   */ clone() {
    ...
    calculateKeyFromCapo() {
        ...
        if (capo && key) {
            const chord = (0, $26f57998457eb2d4$export$2e2bcd8739ae039).parse(key);
...
class $57d8d5c3b509b12e$var$FontSize {
    constructor(fontSize, kind){
        this.fontSize = fontSize;
        this.unit = kind;
    }
    clone() {
        return new $57d8d5c3b509b12e$var$FontSize(this.fontSize, this.unit);
    }
    multiply(percentage) {
        return new $57d8d5c3b509b12e$var$FontSize(this.fontSize * percentage / 100, this.unit);
    }
    /**
   ...
   */ toString() {
    ...
    static parse(fontSize, parent) {
        ...
        return new $57d8d5c3b509b12e$var$FontSize(parsedFontSize, "px");
    }
    static parseNotANumber(parent) {
        if (parent) return parent.clone();
        return new $57d8d5c3b509b12e$var$FontSize(100, "%");
    }
    static parsePercentage(parsedFontSize, parent) {
        if (parent) return parent.multiply(parsedFontSize);
        return new $57d8d5c3b509b12e$var$FontSize(parsedFontSize, "%");
    }
}
var $57d8d5c3b509b12e$export$2e2bcd8739ae039 = $57d8d5c3b509b12e$var$FontSize;



class $2f18b59f691a3b48$var$FontStack {
    fontAndColourStacks = {
        [(0, $5e9ede69210ec54a$export$f7227d9f34d97bec)]: [],
        [(0, $5e9ede69210ec54a$export$2b0cbe6e95114098)]: [],
        [(0, $5e9ede69210ec54a$export$d2ed2b49c006eb23)]: [],
        [(0, $5e9ede69210ec54a$export$14fe4ba6e94df04d)]: []
    };
    sizeStacks = {
        [(0, $5e9ede69210ec54a$export$1f62a95bf5703cac)]: [],
        [(0, $5e9ede69210ec54a$export$f0dee7f48597f09a)]: []
    };
    textFont = new (0, $7de89f83a0afd136$export$2e2bcd8739ae039)();
    chordFont = new (0, $7de89f83a0afd136$export$2e2bcd8739ae039)();
    applyTag(tag) {
        switch(tag.name){
            case 0, $5e9ede69210ec54a$export$14fe4ba6e94df04d:
                this.textFont.font = this.pushOrPopTag(tag);
                break;
            case 0, $5e9ede69210ec54a$export$f0dee7f48597f09a:
                this.textFont.size = this.pushOrPopSizeTag(tag);
                break;
            case 0, $5e9ede69210ec54a$export$d2ed2b49c006eb23:
                this.textFont.colour = this.pushOrPopTag(tag);
                break;
            case 0, $5e9ede69210ec54a$export$2b0cbe6e95114098:
                this.chordFont.font = this.pushOrPopTag(tag);
                break;
            case 0, $5e9ede69210ec54a$export$1f62a95bf5703cac:
                this.chordFont.size = this.pushOrPopSizeTag(tag);
                break;
            case 0, $5e9ede69210ec54a$export$f7227d9f34d97bec:
    ...
    pushOrPopSizeTag(tag) {
        ...
        if (tag.hasValue()) {
            ...
            const parsedFontSize = (0, $57d8d5c3b509b12e$export$2e2bcd8739ae039).parse(value, parent);
...
var $2f18b59f691a3b48$export$2e2bcd8739ae039 = $2f18b59f691a3b48$var$FontStack;
 ...
 */ class $6f653df65dfdf4ef$var$Song extends (0, $59abde4480df2d69$export$2e2bcd8739ae039) {
   ...
   */ lines = [];
    ...
    fontStack = new (0, $2f18b59f691a3b48$export$2e2bcd8739ae039)();
    currentKey = null;
    transposeKey = null;
   ...
   */ get bodyParagraphs() {
    ...
    addLine(line) {
        if (line) this.currentLine = line;
            ...
            this.currentLine = new (0, $bc411321e9739719$export$2e2bcd8739ae039)();
    ...
    expandLine(line) {
        const expandedLines = line.items.flatMap((item)=>{
            if (item instanceof (0, $5e9ede69210ec54a$export$2e2bcd8739ae039) && item.name === (0, $5e9ede69210ec54a$export$8db6c706fc9142b2)) return this.getLastChorusBefore(line.lineNumber);
            return [];
        });
        return [
            line,
    ...
    getLastChorusBefore(lineNumber) {
        ...
        for(let i = lineNumber - 1; i >= 0; i -= 1){
            ...
            if (line.type === (0, $af8d31735c159a26$export$8db6c706fc9142b2)) {
    ...
    filterChorusStartEndDirectives(line) {
        return line.mapItems((item)=>{
            if (item instanceof (0, $5e9ede69210ec54a$export$2e2bcd8739ae039)) {
                if (item.name === (0, $5e9ede69210ec54a$export$4f5168acae064e01) || item.name === (0, $5e9ede69210ec54a$export$473c1a4819e5180b)) return null;
            }
            return item;
        });
    }
   ...
   */ get expandedBodyParagraphs() {
    ...
    addTag(tagContents) {
        const tag = (0, $5e9ede69210ec54a$export$2e2bcd8739ae039).parseOrFail(tagContents);
   ...
   */ setKey(key) {
        ...
        return this.changeMetadata((0, $5e9ede69210ec54a$export$7167c830cefcb6b5), strKey);
    }
    /**
   ...
   */ setCapo(capo) {
        ...
        return this.changeMetadata((0, $5e9ede69210ec54a$export$866f445d49bad88e), strCapo);
    }
    setDirective(name, value) {
        ...
        return this.updateItem((item)=>item instanceof (0, $5e9ede69210ec54a$export$2e2bcd8739ae039) && item.name === name, (item)=>"set" in item ? item.set({
                value: value
 ...
 */ class $1c14afc274b727b7$var$ChordSheetSerializer {
   ...
   */ deserialize(serializedSong) {
    ...
    parseChordLyricsPair(astComponent) {
        ...
        return new (0, $d454f4215ba01af2$export$2e2bcd8739ae039)(chord ? new (0, $26f57998457eb2d4$export$2e2bcd8739ae039)(chord).toString() : chords, lyrics);
    }
 ...
 */ class $6af2b7a7ad6b2cba$var$PegBasedParser {
    song = new (0, $6f653df65dfdf4ef$export$2e2bcd8739ae039)();
    /**
   ...
   */ get warnings() {
    ...
    parseWithParser(chordSheet, parser) {
        const ast = parser((0, $21a34a464e7bc609$export$ba13e0e2f19e61a1)(chordSheet));
        this.song = new (0, $1c14afc274b727b7$export$2e2bcd8739ae039)().deserialize(ast);
        return this.song;
    }
}
var $6af2b7a7ad6b2cba$export$2e2bcd8739ae039 = $6af2b7a7ad6b2cba$var$PegBasedParser;
...
class $1a506a341538d943$export$628c65c376ead699 extends Error {
    static buildMessage(expected, found) {
        function hex(ch) {
            return ch.charCodeAt(0).toString(16).toUpperCase();
        }
    ...
    constructor(message, expected, found, location){
        ...
        this.location = location;
        this.name = "PeggySyntaxError";
        if (typeof Object.setPrototypeOf === "function") Object.setPrototypeOf(this, $1a506a341538d943$export$628c65c376ead699.prototype);
        else this.__proto__ = $1a506a341538d943$export$628c65c376ead699.prototype;
        if (typeof Error.captureStackTrace === "function") Error.captureStackTrace(this, $1a506a341538d943$export$628c65c376ead699);
    }
    format(sources) {
        let str = "Error: " + this.message;
        if (this.location) {
 ...
 */ class $4f0048d666582440$var$ChordProParser extends (0, $6af2b7a7ad6b2cba$export$2e2bcd8739ae039) {
    /**
   * Parses a ChordPro chord sheet into a song
   * @param {string} chordProChordSheet the ChordPro chord sheet
   * @returns {Song} The parsed song
   */ parse(chordProChordSheet) {
        return this.parseWithParser(chordProChordSheet, (0, $1a506a341538d943$export$98e6a39c04603d36));
    }
}
...
to ChordsOverWordsParser, which adds some interesting functionality.`);
   ...
   */ parse(chordSheet, { song: song  } = {}) {
    ...
    initialize(document, song = null) {
        ...
        this.lines = (0, $21a34a464e7bc609$export$ba13e0e2f19e61a1)(document).split("\n");
        this.currentLine = 0;
...
// https://peggyjs.org/   https://github.com/metadevpro/ts-pegjs
"use strict";
function $3df1df9cc0f1cab9$var$peg$padEnd(str, targetLength, padString) {
    padString = padString || " ";
    if (str.length > targetLength) return str;
    targetLength -= str.length;
    padString += padString.repeat(targetLength);
...
class $3df1df9cc0f1cab9$export$628c65c376ead699 extends Error {
    static buildMessage(expected, found) {
        function hex(ch) {
            return ch.charCodeAt(0).toString(16).toUpperCase();
        }
    ...
    constructor(message, expected, found, location){
        ...
        this.location = location;
        this.name = "PeggySyntaxError";
        if (typeof Object.setPrototypeOf === "function") Object.setPrototypeOf(this, $3df1df9cc0f1cab9$export$628c65c376ead699.prototype);
        else this.__proto__ = $3df1df9cc0f1cab9$export$628c65c376ead699.prototype;
        if (typeof Error.captureStackTrace === "function") Error.captureStackTrace(this, $3df1df9cc0f1cab9$export$628c65c376ead699);
    }
    format(sources) {
        let str = "Error: " + this.message;
        if (this.location) {
            ...
            if (src) {
                let e = this.location.end;
                let filler = $3df1df9cc0f1cab9$var$peg$padEnd("", s.line.toString().length, " ");
                let line = src[s.line - 1];
                let last = s.line === e.line ? e.column : line.length + 1;
                str += "\n --> " + loc + "\n" + filler + " |\n" + s.line + " | " + line + "\n" + filler + " | " + $3df1df9cc0f1cab9$var$peg$padEnd("", s.column - 1, " ") + $3df1df9cc0f1cab9$var$peg$padEnd("", last - s.column, "^");
            } else str += "\n at " + loc;
        }
        return str;
    }
}
function $3df1df9cc0f1cab9$var$peg$parse(input, options) {
    options = options !== undefined ? options : {};
    const peg$FAILED = {};
    const peg$source = options.grammarSource;
    const peg$startRuleFunctions = {
    ...
    function peg$buildSimpleError(message, location1) {
        return new $3df1df9cc0f1cab9$export$628c65c376ead699(message, [], "", location1);
    }
    function peg$buildStructuredError(expected1, found, location1) {
        return new $3df1df9cc0f1cab9$export$628c65c376ead699($3df1df9cc0f1cab9$export$628c65c376ead699.buildMessage(expected1, found), expected1, found, location1);
    }
    function peg$parseChordSheet() {
        let s0, s1, s2;
        s0 = peg$currPos;
...
const $427b789bcf346e61$export$24a0bd6af7756225 = [
    "F#m",
    "Gm",
    "G#m",
    "Am",
...
const $427b789bcf346e61$export$1ba61c6fa2f892a9 = {
    Bb: {
        1: "A",
        3: "G",
        6: "E",
...
function $dfecd32049fa58e9$export$74743eda5dda3ccf(key) {
    ...
    return keyObj.isMinor() ? (0, $427b789bcf346e61$export$24a0bd6af7756225) : (0, $427b789bcf346e61$export$1e6f8e38ccd793b);
}
...
function $376e205ced98486b$export$fae3166c418e0471(variables, callback) {
...
function $376e205ced98486b$export$ca030c9435779e4b(font) {
 ...
 */ class $5b02ea769c63fd56$var$HtmlTableFormatter extends (0, $d834af97c9a2e4df$export$2e2bcd8739ae039) {
    get template() {
        return 0, $5381a6b1b90601c7$export$2e2bcd8739ae039;
    }
    get defaultCss() {
